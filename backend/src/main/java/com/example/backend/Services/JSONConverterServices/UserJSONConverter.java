...
public class UserJSONConverter {
    ...
    public Mono<String> toJSON(UserProfile user){
        return Mono.fromCallable(() -> objectMapper.writeValueAsString(user));
    }

    public Mono<UserProfile> fromJSON(String json) {
        return Mono.fromCallable(() -> objectMapper.readValue(json, UserProfile.class));
    }
}
